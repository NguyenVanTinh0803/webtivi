					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +81 337 576 551</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> CyberT@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{URL::to('public/frontend/images/logo0.png')}}" alt="" /></a>
						</div>
...
​									​trang web của chúng tôi và được cập nhật bản thân của bạn.</p>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">© 2023 Hanoi University Of Industry | Design By <a href="">CyberT</a></p>
				</div>
			</div>
		</div>
